...
import json
from module_huiji.danteng_lib import log, read_file
from module_huiji.danteng_excel import read_sheet_from_xlsx
from module_huiji.SaveToExcel import save_to_excel
import os
...
class HuijiWikiTabx(object):
    ...
    def load(self):
        ...
        if len(result) == 1:
            ...
            self._original_data = json.loads(self._raw_text)
            return True
        else:
            return False
